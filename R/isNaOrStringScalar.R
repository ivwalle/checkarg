...
#'
#' @export isNaOrStringScalar
isNaOrStringScalar <- function(argument, default = NULL, stopIfNot = FALSE, message = NULL, argumentName = NULL) {
  
  checkarg(argument, "S", default = default, stopIfNot = stopIfNot, nullAllowed = FALSE, n = 1, naAllowed = TRUE, emptyStringAllowed = TRUE, message = message, argumentName = argumentName)
}
