...
#'
#' @export isBooleanOrNaScalarOrNull
isBooleanOrNaScalarOrNull <- function(argument, default = NULL, stopIfNot = FALSE, message = NULL, argumentName = NULL) {
  
  checkarg(argument, "B", default = default, stopIfNot = stopIfNot, nullAllowed = TRUE, n = 1, naAllowed = TRUE, message = message, argumentName = argumentName)
}
